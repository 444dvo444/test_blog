...
class CreateAboutPageLargoEnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('about_page_largo_ens', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('about_page_largo_ens');
    }
}
